...
L.tileLayer.chinaProvider = function(type, options) {
  ...
  // 1. 先把 Leaflet 原生的 L.map 函数偷偷存到变量里
...
var baseLayers = {
    ...
    L.map = function(id, options) {
        ...
        // ========= 【这里强制塞入你的第一行代码】 =========
        console.log('【拦截成功】有人调用了 L.map，目标 DOM 的 ID 是:', id);
        
        // 示例：在这里强制篡改或注入配置项
        options = options || {};
        // 3. 必须：使用 apply 把原本的参数原封不动还给原函数，并返回实例
        var mapInstance = originalLMap.apply(this, arguments);
